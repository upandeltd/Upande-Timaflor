...
from frappe import _, _dict # type: ignore
from frappe.query_builder import Criterion # type: ignore
from frappe.utils import cstr, getdate # type: ignore

from erpnext import get_company_currency, get_default_company # type: ignore
from erpnext.accounts.doctype.accounting_dimension.accounting_dimension import ( # type: ignore
	get_accounting_dimensions,
	get_dimension_with_children,
)
from erpnext.accounts.report.financial_statements import get_cost_centers_with_children # type: ignore
from erpnext.accounts.report.utils import convert_to_presentation_currency, get_currency # type: ignore
from erpnext.accounts.utils import get_account_currency # type: ignore
...
def get_conditions(filters):
	...
	from frappe.desk.reportview import build_match_conditions # type: ignore
...
def get_accountwise_gle(filters, accounting_dimensions, gl_entries, gle_map, totals):
	...
	def update_value_in_dict(data, key, gle):
		...
		if filters.get("show_net_values_in_party_account") and account_type_map.get(data[key].account) in ( # type: ignore
			"Receivable",
			"Payable",
		):
